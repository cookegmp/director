    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Select which skills to sync to each environment server. Only active and inactive skills
          can be synced.
        </p>
      </div>
            ...
            <thead>
              <tr className="border-b border-border">
                ...
                {environments.map((env) => (
                  <th
                    key={env.id}
                    className="text-center text-xs font-medium text-muted-foreground uppercase tracking-wider px-4 py-3"
                  >
