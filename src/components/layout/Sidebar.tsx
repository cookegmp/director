...
const navItems = [
  ...
  { to: '/engagements', icon: Handshake, label: 'Engagements' },
  { to: '/discovery', icon: Search, label: 'Discovery' },
  { to: '/scaffolding', icon: FolderOpen, label: 'Scaffolding' },
  { to: '/ocai', icon: BarChart3, label: 'OCAI' },
  { to: '/terminology', icon: BookOpen, label: 'Terminology' },
    ...
    <aside className="w-64 bg-sidebar-background border-r border-sidebar-border flex flex-col h-screen sticky top-0 shrink-0">
      <div className="p-6">
        <h1 className="text-xl font-light tracking-tight">
          <span className="animated-gradient-text">Director</span>
        </h1>
        <p className="text-xs text-muted-foreground mt-1">Consultant Operations Hub</p>
      </div>
