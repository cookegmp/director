...
const HIGH_IMPACT_KEYWORDS = [
  'everyone', 'all', 'entire', 'company-wide', 'daily', 'constantly',
  'critical', 'revenue', 'customer', 'safety', 'compliance', 'production',
  'floor', 'delivery', 'quality', 'error', 'waste', 'downtime',
];

const COMPLEXITY_KEYWORDS = [
  'complex', 'difficult', 'legacy', 'integration', 'migrate', 'compliance',
  'security', 'regulation', 'multiple systems', 'erp', 'database',
];

const ALIGNMENT_KEYWORDS = [
  'automation', 'efficiency', 'visibility', 'real-time', 'data-driven',
  'reduce cost', 'improve quality', 'customer satisfaction', 'streamline',
  'digital', 'modernize', 'ai', 'machine learning',
];
